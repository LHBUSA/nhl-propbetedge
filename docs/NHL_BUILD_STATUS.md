...
- Remaining pages: Goalies, Lines, Injuries, News, Props, Shot Lab, Matchups, Players/Player, Team, Standings, Track Record, Methodology.
- History backfill 2022-23 → 2025-26 (raw pbp + boxscore archive, `nhl_games` upsert) and xG shadow baseline — running.
- MLB product-pattern audit (PBEcast command center, Replay, Track Record, Best Line, alerts) → apply to NHL.
- QA screenshot matrix 1440 / 1024 / 390 / 360.
