...
const ROUTES = [
  ...
  { pattern: /^\/teams$/, id: 'teams', load: () => import('../pages/teams.js') },
  { pattern: /^\/winhl$/, id: 'winhl', load: () => import('../pages/winhl.js') },
  { pattern: /^\/fatigue$/, id: 'fatigue', load: () => import('../pages/fatigue.js') },
  { pattern: /^\/fights$/, id: 'fights', load: () => import('../pages/fights.js') },
